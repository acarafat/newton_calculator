...
if (option_s==False and option_u and option_v and option_a==False and option_t):    # ['আদিবেগ (u)', 'শেষবেগ (v)', 'সময় (t)']
    ...
    v = ask_v()
    t = ask_t()
    st.write('বাকি চলক দুইটির মান নির্ণয়ে ব্যবহৃত সমীকরণ: $s = \\frac{1}{2}(u+v)t, \\, a = \\frac{v-u}{t}$')
    s = 0.5*(u+v)*t
    try:
        a = (v-u)/t
    ...
    v = ask_v()
    a = ask_a()
    st.write('বাকি চলক দুইটির মান নির্ণয়ে ব্যবহৃত সমীকরণ: $s = \\frac{v^2-u^2}{2a}, \\, t = \\frac{v-u}{a}$')
    try:
        s = (v*v - u*u)/(2*a)
        t = (v - u)/a
    except ZeroDivisionError:
    ...
    a = ask_a()
    t = ask_t()
    st.write('বাকি চলক দুইটির মান নির্ণয়ে ব্যবহৃত সমীকরণ: $s = ut + \\frac{1}{2}at^2, \\, v = u + at$')
    s = u*t + 0.5*a*t*t
    v = u + a*t
    ...
    a = ask_a()
    t = ask_t()
    st.write('বাকি চলক দুইটির মান নির্ণয়ে ব্যবহৃত সমীকরণ: $s = vt - \\frac{1}{2}at^2, \\, u= v - at$')
    s = v*t - 0.5*a*t*t
    u = v - a*t
    ...
    a = ask_a()
    t = ask_t()
    st.write('বাকি চলক দুইটির মান নির্ণয়ে ব্যবহৃত সমীকরণ: $u = \\frac{s}{t} - \\frac{1}{2}at, \\, v = \\frac{s}{t} + \\frac{1}{2}at$')
    try:
        u = (s - 0.5*a*t*t)/t
        v = (s + 0.5*a*t*t)/t
    except ZeroDivisionError:
    ...
    v = ask_v()
    t = ask_t()
    st.write('বাকি চলক দুইটির মান নির্ণয়ে ব্যবহৃত সমীকরণ: $u = \\frac{2s}{t} - v, \\, a = \\frac{2(vt-s)}{t^2}$')
    try:
        u = (2*s)/t - v
        a = 2*(v*t-s)/(t*t)
    except ZeroDivisionError:
    ...
    v = ask_v()
    a = ask_a()
    st.write('বাকি চলক দুইটির মান নির্ণয়ে ব্যবহৃত সমীকরণ: $u = \\sqrt{v^2 -2as}, \\, t = \\frac{v}{a} - \\frac{\\sqrt{v^2 - 2as}}{a}$')
    try:
    ...
    u = ask_u()
    t = ask_t()
    st.write('বাকি চলক দুইটির মান নির্ণয়ে ব্যবহৃত সমীকরণ: $v = \\frac{2s}{t}-u, \\, a = \\frac{2(s-ut)}{t^2}$')
    try:
        v = (2*s)/t - u
        a = 2*(s-u*t)/(t*t)
    except ZeroDivisionError:
    ...
    u = ask_u()
    a = ask_a()
    st.write('বাকি চলক দুইটির মান নির্ণয়ে ব্যবহৃত সমীকরণ: $v = \\sqrt{u^2 + 2as}, \\, t = -\\frac{u}{a} + \\frac{\\sqrt{u^2 + 2as}}{a}$')
    try:
    ...
    u = ask_u()
    v = ask_v()
    st.write('বাকি চলক দুইটির মান নির্ণয়ে ব্যবহৃত সমীকরণ: $a = \\frac{v^2 - u^2}{2s}, \\, t = \\frac{2s}{u+v}$')
    try:
        a = (v*v - u*u)/(2*s)
    except ZeroDivisionError:
